    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-2xl text-black">
        ...
        <section className="mb-6">
          ...
          <p>
            When you use KingsCouncil, we collect your email address, username, and your progress in chess-based challenges. This information is used to create your account, track your achievements, and personalize your experience.
          </p>
        </section>
        <section className="mb-6">
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6">
            ...
            <li>Contact us at <a href="mailto:aaravh.lala@gmail.com" className="text-chess-primary underline">aaravh.lala@gmail.com</a> for any privacy concerns</li>
          </ul>
        </section>
        <section>
          <h2 className="text-xl font-semibold mb-2">Contact</h2>
          <p>
            If you have any questions about this privacy policy, please contact us at <a href="mailto:aaravh.lala@gmail.com" className="text-chess-primary underline">aaravh.lala@gmail.com</a>.
          </p>
        </section>
      </main>
    </div>
